...
public class OntologyImportsReferenceResolver implements org.emftext.language.owlcl.resource.owlcl.IOwlclReferenceResolver<org.emftext.language.owl.Ontology, org.emftext.language.owl.Ontology> {

	private org.emftext.language.owl.resource.owl.analysis.OntologyImportsReferenceResolver delegate = new org.emftext.language.owl.resource.owl.analysis.OntologyImportsReferenceResolver();

	public void resolve(String identifier, org.emftext.language.owl.Ontology container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.owlcl.resource.owlcl.IOwlclReferenceResolveResult<org.emftext.language.owl.Ontology> result) {
	...
	public String deResolve(org.emftext.language.owl.Ontology element, org.emftext.language.owl.Ontology container, org.eclipse.emf.ecore.EReference reference) {
