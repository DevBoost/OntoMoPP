...
public class IRITargetTargetReferenceResolver implements org.emftext.language.owlcl.resource.owlcl.IOwlclReferenceResolver<org.emftext.language.owl.IRITarget, org.emftext.language.owl.IRIIdentified> {

	private org.emftext.language.owl.resource.owl.analysis.IRITargetTargetReferenceResolver delegate = new org.emftext.language.owl.resource.owl.analysis.IRITargetTargetReferenceResolver();

	public void resolve(String identifier, org.emftext.language.owl.IRITarget container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.owlcl.resource.owlcl.IOwlclReferenceResolveResult<org.emftext.language.owl.IRIIdentified> result) {
	...
	public String deResolve(org.emftext.language.owl.IRIIdentified element, org.emftext.language.owl.IRITarget container, org.eclipse.emf.ecore.EReference reference) {
