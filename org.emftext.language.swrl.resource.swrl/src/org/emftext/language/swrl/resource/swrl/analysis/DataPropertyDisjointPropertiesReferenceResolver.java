...
public class DataPropertyDisjointPropertiesReferenceResolver implements org.emftext.language.swrl.resource.swrl.ISwrlReferenceResolver<org.emftext.language.owl.DataProperty, org.emftext.language.owl.DataProperty> {
	
	private org.emftext.language.owl.resource.owl.analysis.DataPropertyDisjointPropertiesReferenceResolver delegate = new org.emftext.language.owl.resource.owl.analysis.DataPropertyDisjointPropertiesReferenceResolver();
	
	public void resolve(String identifier, org.emftext.language.owl.DataProperty container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.swrl.resource.swrl.ISwrlReferenceResolveResult<org.emftext.language.owl.DataProperty> result) {
