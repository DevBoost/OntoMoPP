...
public class AnnotationPropertyRangesReferenceResolver implements org.emftext.language.swrl.resource.swrl.ISwrlReferenceResolver<org.emftext.language.owl.AnnotationProperty, org.emftext.language.owl.IRIIdentified> {
	
	private org.emftext.language.owl.resource.owl.analysis.AnnotationPropertyRangesReferenceResolver delegate = new org.emftext.language.owl.resource.owl.analysis.AnnotationPropertyRangesReferenceResolver();
	
	public void resolve(String identifier, org.emftext.language.owl.AnnotationProperty container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.swrl.resource.swrl.ISwrlReferenceResolveResult<org.emftext.language.owl.IRIIdentified> result) {
