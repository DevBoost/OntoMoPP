...
public class DataPropertyFactDataPropertyReferenceResolver implements org.emftext.language.owlcl.resource.owlcl.IOwlclReferenceResolver<org.emftext.language.owl.DataPropertyFact, org.emftext.language.owl.DataProperty> {

	private org.emftext.language.owl.resource.owl.analysis.DataPropertyFactDataPropertyReferenceResolver delegate = new org.emftext.language.owl.resource.owl.analysis.DataPropertyFactDataPropertyReferenceResolver();

	public void resolve(String identifier, org.emftext.language.owl.DataPropertyFact container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.owlcl.resource.owlcl.IOwlclReferenceResolveResult<org.emftext.language.owl.DataProperty> result) {
	...
	public String deResolve(org.emftext.language.owl.DataProperty element, org.emftext.language.owl.DataPropertyFact container, org.eclipse.emf.ecore.EReference reference) {
