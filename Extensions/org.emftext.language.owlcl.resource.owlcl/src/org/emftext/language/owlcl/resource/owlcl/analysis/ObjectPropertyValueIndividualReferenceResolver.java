...
public class ObjectPropertyValueIndividualReferenceResolver implements org.emftext.language.owlcl.resource.owlcl.IOwlclReferenceResolver<org.emftext.language.owl.ObjectPropertyValue, org.emftext.language.owl.Individual> {

	private org.emftext.language.owl.resource.owl.analysis.ObjectPropertyValueIndividualReferenceResolver delegate = new org.emftext.language.owl.resource.owl.analysis.ObjectPropertyValueIndividualReferenceResolver();

	public void resolve(String identifier, org.emftext.language.owl.ObjectPropertyValue container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.owlcl.resource.owlcl.IOwlclReferenceResolveResult<org.emftext.language.owl.Individual> result) {
	...
	public String deResolve(org.emftext.language.owl.Individual element, org.emftext.language.owl.ObjectPropertyValue container, org.eclipse.emf.ecore.EReference reference) {
