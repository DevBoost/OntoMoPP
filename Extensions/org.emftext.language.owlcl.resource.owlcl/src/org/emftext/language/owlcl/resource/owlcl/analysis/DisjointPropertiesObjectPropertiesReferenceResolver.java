...
public class DisjointPropertiesObjectPropertiesReferenceResolver implements org.emftext.language.owlcl.resource.owlcl.IOwlclReferenceResolver<org.emftext.language.owl.DisjointProperties, org.emftext.language.owl.ObjectProperty> {

	private org.emftext.language.owl.resource.owl.analysis.DisjointPropertiesObjectPropertiesReferenceResolver delegate = new org.emftext.language.owl.resource.owl.analysis.DisjointPropertiesObjectPropertiesReferenceResolver();

	public void resolve(String identifier, org.emftext.language.owl.DisjointProperties container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.owlcl.resource.owlcl.IOwlclReferenceResolveResult<org.emftext.language.owl.ObjectProperty> result) {
	...
	public String deResolve(org.emftext.language.owl.ObjectProperty element, org.emftext.language.owl.DisjointProperties container, org.eclipse.emf.ecore.EReference reference) {
