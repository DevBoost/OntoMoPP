...
public class IndividualSameAsReferenceResolver implements org.emftext.language.owlcl.resource.owlcl.IOwlclReferenceResolver<org.emftext.language.owl.Individual, org.emftext.language.owl.Individual> {

	private org.emftext.language.owl.resource.owl.analysis.IndividualSameAsReferenceResolver delegate = new org.emftext.language.owl.resource.owl.analysis.IndividualSameAsReferenceResolver();

	public void resolve(String identifier, org.emftext.language.owl.Individual container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.owlcl.resource.owlcl.IOwlclReferenceResolveResult<org.emftext.language.owl.Individual> result) {
