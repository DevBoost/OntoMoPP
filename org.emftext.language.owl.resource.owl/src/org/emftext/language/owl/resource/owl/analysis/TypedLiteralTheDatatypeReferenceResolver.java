...
public class TypedLiteralTheDatatypeReferenceResolver
		implements
		IOwlReferenceResolver<org.emftext.language.owl.TypedLiteral, org.emftext.language.owl.Datatype> {

	private OwlDefaultResolverDelegate<org.emftext.language.owl.TypedLiteral, org.emftext.language.owl.Datatype> delegate = new OwlDefaultResolverDelegate<org.emftext.language.owl.TypedLiteral, org.emftext.language.owl.Datatype>();

	public java.lang.String deResolve(
			org.emftext.language.owl.Datatype element,
			org.emftext.language.owl.TypedLiteral container,
