...
public class ObjectPropertyValueIndividualReferenceResolver
		implements
		IOwlReferenceResolver<org.emftext.language.owl.ObjectPropertyValue, org.emftext.language.owl.Individual> {

	private OwlDefaultResolverDelegate<org.emftext.language.owl.ObjectPropertyValue, org.emftext.language.owl.Individual> delegate = new OwlDefaultResolverDelegate<org.emftext.language.owl.ObjectPropertyValue, org.emftext.language.owl.Individual>();

	public java.lang.String deResolve(
			org.emftext.language.owl.Individual element,
			org.emftext.language.owl.ObjectPropertyValue container,
